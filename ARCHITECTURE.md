...
**Dua aturan batas tambahan** (dikunci di `ARCHITECTURE_REVIEW.md` §B, ditegakkan sebagai bagian dari transformasi produk Arkavena OS Fase 12 — IMPLEMENTATION_PLAN.md Fase 1, F25/F26), keduanya belum pernah dilanggar tapi belum pernah ditulis eksplisit sebelum ini:
